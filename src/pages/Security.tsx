        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <ShieldAlert className="w-8 h-8 text-gray-900 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900">Encryption</h3>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <Server className="w-8 h-8 text-gray-900 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900">Infrastructure</h3>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <Fingerprint className="w-8 h-8 text-gray-900 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900">Access Control</h3>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <Activity className="w-8 h-8 text-gray-900 mx-auto mb-3" />
