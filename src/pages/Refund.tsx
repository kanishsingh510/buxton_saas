        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <RefreshCw className="w-8 h-8 text-gray-900 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900">Processing</h3>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <FileCheck className="w-8 h-8 text-gray-900 mx-auto mb-3" />
              <h3 className="font-semibold text-gray-900">Eligibility</h3>
            </div>
            <div className="bg-white rounded-xl border border-gray-200 p-6 text-center">
              <CreditCard className="w-8 h-8 text-gray-900 mx-auto mb-3" />
